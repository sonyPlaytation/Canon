...
pos_height = 150 // how tall the history area is (the textbox starts after this)
pos_margin_sides = 24 // how far away from the sides the box should be 
pos_inner_padding_sides = 8 // how much room should there be between the text and the side of the box
pos_inner_padding_bottom = 8 // this is how much room is between the bottom of the text area and the bottom text line
main_area_height = 26 // the height of the text area 
